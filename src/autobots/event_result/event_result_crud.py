...
from src.autobots.event_result.event_result_model import EventResultDoc, EventResultDocCreate, EventResultDocFind, \
    EventResultDocUpdate, EventResultLiteDoc


class EventResultCRUD(CRUDBase[EventResultDoc, EventResultLiteDoc, EventResultDocCreate, EventResultDocFind, EventResultDocUpdate]):
    ...
    def __init__(self, db: AsyncIOMotorDatabase = Depends(get_mongo_db)):
        ...
        super().__init__(EventResultDoc, EventResultLiteDoc, document)
