...
async def sd_img2img(
    req: SDImg2ImgReqModel, max_retry=3
) -> SDImg2ImgResError | SDImg2ImgProcessingModel | SDImg2ImgResModel:
    """
    ...
    try:
        ...
        logger.error(
            f"Stable diffusion img2img validation error for response: {str(e)}"
        )
