...
router = APIRouter(
    prefix=SettingsProvider.sget().API_ACTION_RESULTS,
    tags=[SettingsProvider.sget().API_ACTION_RESULTS],
)
...
async def list_action_result(
    ...
    action_result_docs = await user_action_result.list_action_result(
