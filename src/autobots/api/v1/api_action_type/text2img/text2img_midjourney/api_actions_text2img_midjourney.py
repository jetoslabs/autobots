...
from src.autobots.conn.useapi.text2img.text2img_model import DiscordErrorResponse, DiscordReqModel, DiscordJobsApiResponse
...
async def run_action_text2img_midjourney_button(
        action_id: str,
