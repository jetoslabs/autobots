...
class Text2ImgRunModel(BaseModel):
    ...
    width: Optional[int] = Field(
        default=None, ge=0, le=1024, description="Max Height: Width: 1024x1024."
    )
...
class ActionText2ImgStableDiffusion(
    IAction[Text2ImgReqModel, Text2ImgRunModel, StableDiffusionRes]
):
