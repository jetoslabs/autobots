...
from src.autobots.conn.stable_diffusion.text2video.text2video_model import Text2VideoReqModel, Text2VideoScheduler
...
class ActionText2VideoStableDiffusion(
    ActionABC[Text2VideoReqModel, Text2VideoReqModel, Text2VideoReqModel, Text2VideoRunModel, StableDiffusionRes]
):
    ...
    def __init__(self, action_config: Text2VideoReqModel, user: UserORM | None = None):
        super().__init__(action_config=action_config, user=user)

    async def run_action(self, ctx: Context, action_input: Text2VideoRunModel) -> StableDiffusionRes:
