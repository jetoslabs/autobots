...
class ActionImageMixerStableDiffusion(
    ...
    def __init__(self, action_config: ImageMixerReqModel, user: UserORM | None = None):
        super().__init__(action_config=action_config, user=user)

    async def run_action(self, ctx: Context, action_input: ImageMixerRunModel) -> StableDiffusionRes:
