...
#                                               messages=[
#                                                   {"role": "system",
#                                                    "content": "You are an assistant tasked with summarizing tables and text for retrieval."},
...
#         raw_pdf_elements = s.general.partition(request=partition_request)
#
#         # # Get text, tables
...
#             texts = []
#             texts_4k_token_agen = DataProvider.create_data_chunks(joined_texts, DataProvider.read_data_line_by_line,
#                                                                   4000
#                                                                   )
