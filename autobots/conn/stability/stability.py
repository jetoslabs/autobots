...
class Stability:
    ...
    async def text_to_image(
        ...
        answers = self.stability_api.generate(
            ...
            seed=seed,  # 992446758,  # If a seed is provided, the resulting generated image will be deterministic.
            ...
            cfg_scale=cfg_scale,  # 8.0,  # Influences how strongly your generation is guided to match your prompt.
            # Setting this value higher increases the strength in which it tries to match your prompt.
            # Defaults to 7.0 if not specified.
            width=width,  # 512,  # Generation width, defaults to 512 if not included.
            height=height,  # 512,  # Generation height, defaults to 512 if not included.
            samples=samples,  # 1,  # Number of images to generate, defaults to 1 if not included.
