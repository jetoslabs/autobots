...
from autobots.conn.openai.openai_assistants.assistant_model import AssistantCreate, AssistantRetrieve, AssistantList, \
    AssistantDelete, AssistantUpdate, AssistantFileInput, AssistantFileListInput
from autobots.conn.openai.openai_assistants.openai_threads.openai_threads import OpenaiThreads
