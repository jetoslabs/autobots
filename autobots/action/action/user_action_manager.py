...
#                 return await ActionGenTextLlmChatOpenaiV2.run_raw_action(action, action_input)
#             case ActionType.text2img_dalle_openai:
#                 return await ActionGenImageDalleOpenAiV2.run_raw_action(action, action_input)
#             case ActionType.text2img_stability_ai:
#                 return await ActionGenImageStabilityAiV2.run_raw_action(action, action_input)
#             case ActionType.text2text_llm_chat_with_vector_search_openai:
#                 return await ActionGenTextLlmChatWithVectorSearchOpenai.run_raw_action(action, action_input)
#             case ActionType.text2img_stable_diffusion:
#                 return await ActionText2ImgStableDiffusion.run_raw_action(action, action_input)
#             case ActionType.image_mixer_stable_diffusion:
#                 return await ActionImageMixerStableDiffusion.run_raw_action(action, action_input)
#             case ActionType.text2video_stable_diffusion:
#                 return await ActionText2VideoStableDiffusion.run_raw_action(action, action_input)
#             case _:
...
#         return await action.run_raw_action_in_background(action_doc, action_input, user_action_result, background_tasks)
