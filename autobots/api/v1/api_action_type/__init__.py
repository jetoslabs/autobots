...
from autobots.api.v1.api_action_type.img2img import image_mixer_stable_diffusion, api_actions_img2img_edit_openai, \
...
from autobots.api.v1.api_action_type.text2img import api_actions_text2img_openai, api_actions_text2img_stable_diffusion, \
    api_actions_text2img_stability_ai, api_actions_text2img_midjourney
...
router.include_router(api_actions_text2img_midjourney.router, tags=[f"{prefix}/text2img"])
# img2img
