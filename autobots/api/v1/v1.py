...
router.include_router(api_actions.router, prefix=settings.API_ACTIONS)
...
router.include_router(fetch_stable_diffusion.router, tags=["action_results/stable_diffusion"])
