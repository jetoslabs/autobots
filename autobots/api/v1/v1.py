...
from autobots.api.v1 import api_hello, api_auth, api_prompts, api_graphs, api_actions, api_action_graphs, api_docs, \
    api_datastore, api_chat, api_agents, api_action_market
...
router.include_router(api_action_market.router, prefix=get_settings().API_ACTION_MARKET, tags=["action_market"])
