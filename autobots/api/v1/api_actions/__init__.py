...
from autobots.api.v1.api_actions.audio2text import api_actions_audio2text_openai
...
# audio2text
router.include_router(api_actions_audio2text_openai.router, tags=["actions/audio2text"])
