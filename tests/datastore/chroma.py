...
class Document(BaseMedia):
    ...
    def __str__(self) -> str:
        ...
        return f"page_content='{self.page_content}'{metadata_str}"
...
async def run_in_executor(
    executor_or_config: Optional[Union[Executor, dict]],
    func: Callable[..., T],
    *args: Any,
    **kwargs: Any,
) -> T:
    ...
    Args:
        executor_or_config (Optional[Union[Executor, dict]]): The executor or configuration dictionary.
    ...
    return await loop.run_in_executor(executor_or_config, wrapper)
